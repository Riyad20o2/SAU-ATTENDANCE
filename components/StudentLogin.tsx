...
import { User, Lock, ArrowRight, Mail, Camera, Upload, ChevronLeft, Eye, EyeOff, AlertCircle, CheckCircle2 } from 'lucide-react';
            ...
            >
              ...
              <form onSubmit={!isLogin && step === 1 ? handleNextStep : handleSubmit} className="space-y-4 relative z-10">
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3.5 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 mt-4 group relative overflow-hidden"
                >
                  {isLoading && !error ? (
